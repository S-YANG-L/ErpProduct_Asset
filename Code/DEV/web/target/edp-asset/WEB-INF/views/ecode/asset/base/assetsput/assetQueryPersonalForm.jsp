...
<div class="portlet box ${boxStyleColor} autoHeight">
    ...
    <div class="portlet-body form">
        ...
        <div class="form-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        <label class="control-label col-sm-4" title="">资产分类名称：<i class="fa icon-question hide"></i></label>
                        <div class="col-sm-8">
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        <label class="control-label col-sm-4" title="">公司名称：<i class="fa icon-question hide"></i></label>
                        <div class="col-sm-8">
                            <form:input path="companyName" htmlEscape="false" maxlength="100" readonly="true"
                                        class="form-control required"/>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        <label class="control-label col-sm-4" title="">存放地点：<i class="fa icon-question hide"></i></label>
                        <div class="col-sm-8">
                            <form:input path="storagePlace" htmlEscape="false" maxlength="100" readonly="true"
                                        class="form-control required"/>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $("#dataGrid").dataGrid({
            ...
            // 设置数据表格列
            columnModel: [
                {header: '处理方式', name: 'aaa', width: 45, align: "center",
