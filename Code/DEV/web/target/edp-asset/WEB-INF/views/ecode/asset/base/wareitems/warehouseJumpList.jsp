...
<div class="portlet box">
    <div class="portlet-body list">
        <form:form id="searchForm" modelAttribute="warehouseItems" action="${ctx}/wareitems/warehouseItems/listData"
                   ...
                   <form:hidden path="sortCode"/>
            <div class="form-group" hidden="hidden">
                <label class="control-label">仓库名称：</label>
                <div class="input-inline">
                    <form:select path="whCode" class="form-control input-sm width-160"
                                 onchange="selProjectName()">
                        <form:option value="" label=""/>
                        <form:options items="${warehouses}" itemLabel="warehouseName" itemValue="warehouseCode"
                                      htmlEscape="false"/>
                    </form:select>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#dataGrid').dataGrid({
            ...
            // 设置数据表格列
            columnModel: [
                {header: '主键',name: 'id',index: 'a.id',width: 200,align: "left",hidden: true,frozen: true},
                {header: '办公用品编码',name: 'articlesCode',index: 'a.articles_code',width: 200,align: "left",hidden: true, frozen: true},
                {header: '办公用品名称',name: 'articlesName',index: 'a.articles_name',width: 200,align: "left",frozen: true},
