...
<div class="portlet box">
	<div class="portlet-body list">
		<form:form id="searchForm" modelAttribute="assetUsedDtl" action="${ctx}/usedinfo/assetUsedInfo/getDtlDataReturn?user=${assetUsedDtl.user}" method="post" class="breadcrumb form-inline "
