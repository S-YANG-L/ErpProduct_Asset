...
<sys:header title="借用归还表" extLibs="${extLibs}"/>
<style>
    .nav_right ul li {
        margin-top: 10px;
...
<div class="nav_right nav2">
    <ul>
        <li class="active" onclick="showTab(this,'${ctx}/borrow/assetBorrowInfo/list')"><span>借用</span></li>
        <li onclick="showTab(this,'${ctx}/return/assetBorrowReturn/list')"><span>归还</span></li>
    </ul>
</div>
<iframe id="reportFrame" src="${ctx}/borrow/assetBorrowInfo/list"></iframe>
