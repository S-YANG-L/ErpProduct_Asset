...
<div class="portlet box ${boxStyleColor}">
	<div class="portlet-title">
		<div class="caption"><i class="fa fa-tasks"></i> ${param.flag eq '1' ? '已办' : '办结'}事宜</div>
		<div class="actions">
	...
	<div class="portlet-body list">
		<form:form id="searchForm" action="${ctx}/flow/process/listData?flag=${param.flag}" method="post" class="breadcrumb form-inline"
			...
			<%-- <div class="form-group">
				...
				<select name="processInstanceStatus" class="form-control input-sm width-90">
	...
	var dataGrid = new DataGrid({
		...
		columnModel: [
	       	{header:'单据号', name:'bizKey', width:200, align:"center", sortable:false, formatter: function(val, obj, row, act){
	   			return '<a name="viewTask" href="#" formUri="${ctx}'+row.formUri+'" bizKey="'+row.bizKey+'" taskTitle="'+row.subject+'">'+val+'</a>';
	   		}},
		    ...
		    {header:'发起人', name:'startAuthorName', width:140, sortable:false, align:"center"},
