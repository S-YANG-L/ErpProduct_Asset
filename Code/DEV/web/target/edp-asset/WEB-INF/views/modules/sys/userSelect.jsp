...
<div class="portlet box">
	<div class="portlet-body list">
		<form:form id="searchForm" modelAttribute="user" action="${ctx}/sys/user/listData?isAll=${param.isAll}" method="post" class="breadcrumb form-inline "
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#dataGrid').dataGrid({
			...
			// 设置数据表格列
			columnModel: [
				{header:'用户名称', name:'userName', index:'user_name', width:100, align:"center"},
				{header:'登录账号', name:'loginCode', index:'login_code', width:100, align:"center"},
				//<c:if test="${fns:getModule('core_extend').isEnable}">
				{header:'所属公司', name:'refObj.companyNameSimple', index:'c.company_name_simple', width:160, align:"center"},//</c:if>
				{header:'组织机构', name:'refObj.officeName', index:'d.office_name', width:160, align:"center"},
				<%--//<c:if test="${fns:getModule('core_extend').isEnable}">
				{header:'员工姓名', name:'refObj.empName', index:'emp_name', width:100},
				{header:'员工编码', name:'refObj.empNo', index:'emp_no', width:100},//</c:if>--%>
				{header:'电话', name:'phone', index:'phone', width:150, sortable:false},
				{header:'手机', name:'mobile', index:'mobile', width:150, sortable:false},
