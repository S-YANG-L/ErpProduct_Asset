...
<sys:header title="分类管理 - ${assetSort.isNewRecord ? '新增' : '编辑'}分类" extLibs="${extLibs}"/>
<div class="portlet box ${boxStyleColor} autoHeight">
	<div class="portlet-title">
		<div class="caption"><i class="fa fa-coffee"></i>${assetSort.isNewRecord ? '新增' : '编辑'}分类</div>
	</div>
			...
			<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<%--<sys:treeselect id="parent" name="parent.id" value="${assetSort.parent.id}" labelName="parent.sortName" labelValue="${assetSort.parent.sortName}"
									 title="上级编码" url="/ass/assetSort/treeData" cssClass="form-control" allowClear="true"/>--%>
								<sys:treeselect id="parent" name="parent.id" value="${assetSort.parent.id}" labelName="parent.sortName" labelValue="${assetSort.parent.sortName}"
					...
					<%--<div class="col-xs-6">
						<div class="form-group">
							<label class="control-label col-sm-4" title="">
								<span class="required">*</span> 分类级别：<i class="fa icon-question hide"></i></label>
							<div class="col-sm-8">
								<form:input path="sortGrade" htmlEscape="false" maxlength="64" class="form-control required"/>
							</div>
						</div>
					</div>--%>
				</div>
				...
				<div class="row">
					...
					<div class="col-xs-6">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<form:input path="assetUnit" htmlEscape="false" maxlength="20" class="form-control required"/>
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-xs-6">
						<div class="form-group">
							<label class="control-label col-sm-4" title="">
								<span class="required">*</span> 使用年限(月)：<i class="fa icon-question hide"></i></label>
							<div class="col-sm-8">
					...
					<div class="col-xs-6">
						<div class="form-group">
							<label class="control-label col-sm-4" title="">
								<span class="required">*</span> 净残值率：<i class="fa icon-question hide"></i></label>
							<div class="col-sm-8">
								<form:input path="netsalvageRate" htmlEscape="false" class="form-control required number"/>
							</div>
						</div>
					</div>
				</div>
