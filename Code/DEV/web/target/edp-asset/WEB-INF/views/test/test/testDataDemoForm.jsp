		...
		<form:form id="inputForm" modelAttribute="testData" action="${ctx}/test/testData/save" method="post" class="form-horizontal">
			<div class="form-body">
				...
				<div class="row">
					...
					<div class="col-xs-6">
						<div class="form-group">
							<label class="control-label col-sm-4">列表选择：</label>
							<div class="col-sm-8">
								<sys:listselect id="user2" name="user.userCode" value="${testData.user.userCode}" labelName="user.userName" labelValue="${testData.user.userName}"
				...
				<div class="row">
					<div class="col-xs-6">
						<div class="form-group">
							<label class="control-label col-sm-4">下拉列表：</label>
							<div class="col-sm-8">
					...
					<div class="col-xs-6">
						<div class="form-group">
							<label class="control-label col-sm-4">下拉多选：</label>
							<div class="col-sm-8">
								<form:select path="sex" class="form-control required" multiple="true">
									<form:options items="${fns:getDictList('sex')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
								</form:select>
								<span class="help-block">&nbsp;</span>
							</div>
				...
				<div class="row">
					<div class="col-xs-6">
						<div class="form-group">
							<label class="control-label col-sm-4">单选按钮：</label>
							<div class="col-sm-8">
					...
					<div class="col-xs-6">
						<div class="form-group">
							<label class="control-label col-sm-4">多选按钮：</label>
							<div class="col-sm-8">
