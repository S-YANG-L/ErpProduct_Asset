 ...
 * @version 2018-10-11
 */
public class AssetCleanDtl extends DataEntity<AssetCleanDtl> {
	
	private static final long serialVersionUID = 1L;
	private String cleanCode;		// 清理编码 父类
	...
	private String cleanerName;		// 还原人
	private String cleanerCode;		// 还原人编码
	private Date cleanDate;		// 还原时间
    private String cleanDateString;		// 还原时间
	private Date beginDate;//开始日期
	private Date endDate;//结束日期
	private String assetStatus;		// 资产状态
	public AssetCleanDtl() {
		super();
	}

	public AssetCleanDtl(String id){
		super();
		this.id = id;
	}
	...
	@ExcelField(title = "资产小类",align = 1,sort = 3)
	...
	@ExcelField(title = "型号",align = 1,sort = 5)
    ...
    public String getCleanDateString() {
        return cleanDateString;
    }

    public void setCleanDateString(String cleanDateString) {
        this.cleanDateString = cleanDateString;
    }
}