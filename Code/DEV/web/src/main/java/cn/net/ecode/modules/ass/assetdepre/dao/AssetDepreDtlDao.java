 ...
 */
package cn.net.ecode.modules.ass.assetdepre.dao;
 ...
 */
@MyBatisDao
public interface AssetDepreDtlDao extends CrudDao<AssetDepreDtl> {

    List<AssetDepreDtl> findListDtl(AssetDepreDtl assetDepreDtl);
}