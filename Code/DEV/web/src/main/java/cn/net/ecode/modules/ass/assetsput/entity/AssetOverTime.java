 ...
 * 清理过期
 */
public class AssetOverTime extends DataEntity<AssetOverTime> {
	 ...
	 * 资产处理记录
	 */
	private String aaa;//处理方式
	private String dealDate;//处理时间
	private String dealName;//处理人名称
	private String dealAll;//处理内容
	private String cleanerName;
	private String cleanerCode;
	private Date cleanDate;
	public AssetOverTime() {
		super();
}

	public AssetOverTime(String id){
		super();
		this.id = id;
	}
	...
	private List<AssetCleanDtl> assetCleanDtlList = Lists.newArrayList();
