...
<div class="content-comment">
	<h5><strong>评论列表</strong></h5>
	<ul>
		<c:forEach items="${page.list}" var="comment">
			<li>
				<h6><strong>姓名: ${comment.name} &nbsp;时间：<fmt:formatDate value="${comment.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
					&nbsp; <a href="javascript:comment('${comment.id}')">回复</a></strong></h6>
	...
	<form:form action="${ctx}/comment" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls" style="position: relative;">
				...
				<label class="mid" style="display:inline;">&nbsp;&nbsp;&nbsp;姓名:</label>
