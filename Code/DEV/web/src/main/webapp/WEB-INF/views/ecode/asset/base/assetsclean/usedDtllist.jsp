...
<div class="portlet box">
	<div class="portlet-body list">
		<form:form id="searchForm" modelAttribute="assetInfo" action="${ctx}/assetsclean/assetClean/listDataCode?assetCode=${assetInfo.assetCode}&assetStatus=0" method="post" class="breadcrumb form-inline "
    ...
    $(document).ready(function() {
        ...
        $('#dataGrid').dataGrid({
            ...
            columnModel: [
                ...
                {header:'资产小类编码', name:'sortCode', index:'a.sort_code', hidden:true,width:200, align:"left"},
                ...
                {header:'SN号', name:'snCode', index:'a.sn_code', width:200,hidden:true, align:"left"},
