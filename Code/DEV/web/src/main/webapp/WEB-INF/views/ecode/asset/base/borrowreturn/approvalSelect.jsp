...
<div class="portlet box">
	<div class="portlet-body list">
		<form:form id="searchForm" modelAttribute="flowBusiness" action="${ctx}/return/assetBorrowReturn/listApprovalData" method="post" class="breadcrumb form-inline "
				data-page-no="${page.pageNo}" data-page-size="${page.pageSize}" data-order-by="${page.orderBy}">
				<input type="hidden" name="flowId" value="${flowBusiness.flowId }"/>
				<input type="hidden" name="applicantCode" value="${flowBusiness.applicantCode }"/>
				<input type="hidden" name="billAmt" value="${flowBusiness.billAmt }"/>
				<input type="hidden" name="flowTemplatesId" value="${flowBusiness.flowTemplatesId }"/>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#dataGrid').dataGrid({
			...
			// 设置数据表格列
			columnModel: [
 				{header:'用户编码', name:'userCode', index:'user_code', width:200, align:"left"},
