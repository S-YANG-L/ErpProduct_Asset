...
<div class="portlet box">
	<div class="portlet-body list">
		<form:form id="searchForm" modelAttribute="assetInfo" action="${ctx}/borrow/assetBorrowInfo/listDataCode?assetCode=${assetInfo.assetCode}&sortCode=${assetInfo.sortCode}" method="post" class="breadcrumb form-inline "
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#dataGrid').dataGrid({
            ...
            // 设置数据表格列
            columnModel: [
                {header:'状态', name:'assetStatus', index:'a.asset_status', width:200, align:"left",formatter: function(val, obj, row, act){
                ...
                {header:'资产分类编码', name:'sortCode', index:'a.sort_code', hidden:true, width:200, align:"left"},
                ...
                {header:'SN号', name:'snCode', index:'a.sn_code', hidden:true, width:200, align:"left"},
                ...
                {header:'使用人', name:'userName', index:'a.user_name',hidden:true, width:200, align:"left"},
