...
<div class="portlet box">
	<div class="portlet-body list">
		<form:form id="searchForm" modelAttribute="assetInfo" action="${ctx}/ass/assetInfo/listDataAllot" method="post" class="breadcrumb form-inline "
	...
	$(document).ready(function() {
		...
		$('#dataGrid').dataGrid({
			...
			columnModel: [
                ...
                {header:'资产分类编码', name:'sortCode', index:'a.sortCode', width:200, align:"left",hidden: true,},
