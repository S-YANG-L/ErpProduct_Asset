...
values ('0', '默认角色', 'default', '1', '1', 'system', now(), 'system', now(), '非管理员用户，共有的默认角色', '0', '易科德软件', null);
insert into SYS_ROLE (ROLE_CODE, ROLE_NAME, NAME_EN, IS_SYS, IS_SHOW, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, CORP_CODE, CORP_NAME, ROLE_TYPE)
values ('1', '系统管理员', 'corp_admin_user', '1', '1', 'system', now(), 'system', now(), '客户方使用的角色，客户方管理员，集团管理员', '0', '易科德软件', null);
insert into SYS_ROLE (ROLE_CODE, ROLE_NAME, NAME_EN, IS_SYS, IS_SHOW, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, CORP_CODE, CORP_NAME, ROLE_TYPE)
values ('2', '二级管理员', 'sec_admin_user', '1', '1', 'system', now(), 'system', now(), '由客户方管理员设置使用，可以设置本单位的二级管理员', '0', '易科德软件', null);
...
values ('system', '71f67eb14ba775fd9ad43b61b1fcc19114df5bbcabe46a8f06e90b4d', '超级管理员', null, null, null, null, null, '0', null, null, '0', '127.0.0.1', now(), null, '0', 'system', now(), 'system', now(), null, 'system', '0', '易科德软件', null, null);
insert into SYS_USER (USER_CODE, PASSWORD, USER_NAME, EMAIL, MOBILE, PHONE, PHOTO, IMEI, USER_TYPE, REF_CODE, REF_NAME, MGR_TYPE, LOGIN_IP, LOGIN_DATE, FREEZE_DATE, STATUS, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, LOGIN_CODE, CORP_CODE, CORP_NAME, WX_OPENID, SESSION_ID)
values ('admin', '38e7994a556a30b21cca16a3d782011e3cd46e0300bea86913af7781', '系统管理员', null, null, null, null, null, '0', null, null, '1', '127.0.0.1', now(), null, '0', 'system', now(), 'system', now(), null, 'admin', '0', '易科德软件', null, null);
...
values ('1', '默认站点', '演示站点', null, null, null, null, 'basic', '<!--HTML--><p>版权所有：山东易科德软件有限公司</p>', null, null, 'system', now(), 'system', now(), '0');
