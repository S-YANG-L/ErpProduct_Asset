	...
	var dataGrid = new DataGrid({
		...
		columnModel: [
  	     	{header:'流程名称', name:'name', width:260, align:"left", sortable:false, formatter: function(val, obj, row, act){
	   			return '<a name="doTask" class="btnList" href="${ctx}/jflow/search/flowList?FK_Flow=' + row.no + '" title="'+val+'"><img src="${ctxPath}/WF/Img/WFState/Runing.png" class="Icon" align="middle" width="16px"/> <b>'+val+'</b></a>';
			}},
			...
			{header:'操作', name:'actions', width:120, fixed:true, sortable:false,align:"center", formatter: function(val, obj, row, act){
				var actions = [];
				//查询
				actions.push('&nbsp;<a name="doTask" class="btnList" href="${ctxPath}/jflow/search/flowList?FK_Flow=' + row.no + '" title="查询"><i class="fa fa-search")></i></a>&nbsp;');
				//流程图
