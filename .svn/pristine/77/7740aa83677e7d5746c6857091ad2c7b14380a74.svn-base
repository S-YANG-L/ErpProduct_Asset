 ...
 * @version 2018-10-09
 */
public class AssetBorrowReturnDtl extends DataEntity<AssetBorrowReturnDtl> {
	...
	private String yuanuserName;
	private String assetStatus;
	public AssetBorrowReturnDtl() {
		super();
	}

	public AssetBorrowReturnDtl(String id){
		super();
		this.id = id;
	}
