...
<div class="portlet box">
	<div class="portlet-body list">
		<form:form id="searchForm" modelAttribute="btypeInfo" action="${ctx}/mdm/select/btypeListData?isAll=${param.isAll}" method="post" class="breadcrumb form-inline"
	...
	$(document).ready(function() {
		...
		$('#dataGrid').dataGrid({
			...
			columnModel: [
				...
				{header:'所在区市编码', name:'areaCode', index:'mobile', width:80, sortable:false,hidden:true},
				{header:'所在区市', name:'areaName', index:'mobile', width:120, sortable:false},
