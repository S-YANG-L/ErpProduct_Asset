 ...
 */
package cn.net.ecode.modules.ass.borrowreturn.entity;
 ...
 * @version 2018-10-09
 */
public class AssetBorrowReturn extends DataEntity<AssetBorrowReturn> {
	...
	List<AssetBorrowReturnDtl> assetBorrowReturnDtl;
	//调用JUDP3.0工作流所需属性
	...
	public AssetBorrowReturn() {
		super();
	}

	public AssetBorrowReturn(String id){
		super();
		this.id = id;
	}
	...
	public List<AssetBorrowReturnDtl> getAssetBorrowReturnDtl() {
		return assetBorrowReturnDtl;
	}

	public void setAssetBorrowReturnDtl(List<AssetBorrowReturnDtl> assetBorrowReturnDtl) {
		this.assetBorrowReturnDtl = assetBorrowReturnDtl;
	}
