...
<fieldset>
	<legend>流转信息</legend>
	<div id="historyFlowList">
		正在加载流转信息...
	</div>
</fieldset>
<script type="text/javascript">
	$.get("${ctx}/flow/task/historyFlow?procInsId=${procInsId}&startAct=${startAct}&endAct=${endAct}&t="+new Date().getTime(), function(data){
		$("#historyFlowList").html(data);
	});
</script>